<aside class="col-lg-3 col-md-3 col-sm-3 m_xs_bottom_30">
    ...
    <figure class="widget animate_ftr shadow r_corners wrapper m_bottom_30">
        ...
        <div class="widget_content">
            <div class="clearfix m_bottom_15 relative cw_product">
                <img src="{{URL::to('front_end_resource/images/bestsellers_img_1.jpg')}}" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
            ...
            <div class="clearfix m_bottom_25 relative cw_product">
                <img src="{{URL::to('front_end_resource/images/bestsellers_img_2.jpg')}}" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
    ...
    <a href="#" class="widget animate_ftr d_block r_corners m_bottom_30">
        <img src="{{URL::to('front_end_resource/images/banner_img_6.jpg')}}" alt="">
    </a>
    <!--Bestsellers-->
    <figure class="widget animate_ftr shadow r_corners wrapper m_bottom_30">
        <figcaption>
        ...
        <div class="widget_content">
            ...
            <div class="clearfix m_bottom_5">
                <img src="{{URL::to('front_end_resource/images/bestsellers_img_3.jpg')}}" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
