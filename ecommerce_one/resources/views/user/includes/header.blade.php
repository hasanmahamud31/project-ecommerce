                ...
                <div class="col-lg-4 col-md-4 col-sm-3 t_align_r t_xs_align_c">
                    <ul class="horizontal_list clearfix d_inline_b t_align_l f_size_small site_settings type_2">
                        <li class="container3d relative">
                            <a role="button" href="#" class="color_dark" id="lang_button"><img class="d_inline_middle m_right_10" src="{{URL::to('front_end_resource/images/flag_en.jpg')}}" alt="">English</a>
                            <ul class="dropdown_list type_2 top_arrow color_light">
                                <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="{{URL::to('front_end_resource/images/flag_en.jpg')}}" alt="">English</a></li>
                                <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="{{URL::to('front_end_resource/images/flag_fr.jpg')}}" alt="">French</a></li>
                                <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="{{URL::to('front_end_resource/images/flag_g.jpg')}}" alt="">German</a></li>
                                <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="{{URL::to('front_end_resource/images/flag_i.jpg')}}" alt="">Italian</a></li>
                                <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="{{URL::to('front_end_resource/images/flag_s.jpg')}}" alt="">Spanish</a></li>
                            </ul>
                        </li>
                ...
                <div class="clearfix t_sm_align_l f_left f_sm_none relative s_form_wrap m_sm_bottom_15 p_xs_hr_0 m_xs_bottom_5">
                    ...
                    <nav role="navigation" class="f_left f_xs_none d_xs_none m_right_35 m_md_right_30 m_sm_right_0">	
                        <ul class="horizontal_list main_menu type_2 clearfix">
                            ...
                            <li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="category_grid.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b> Shop By Category </b></a>
                                <!--sub menu-->
                                <div class="sub_menu_wrap top_arrow d_xs_none tr_all_hover clearfix r_corners w_xs_auto">
                                    ...
                                    <img src="{{URL::to('front_end_resource/images/woman_image_1.jpg')}}" class="d_sm_none f_right m_bottom_10" alt="">
                                </div>
                            </li>
                            <li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <form class="relative type_2" >
                                        <div class="f_left f_xs_none">
                                        ...
                                        <div class="f_left f_xs_none">
                                            <div class="custom_select relative color_dark portfolio_filter d_inline_b t_align_l d_xs_block">
                                                <div class="select_title type_2 r_corners relative mw_0">Select Category</div>
...
<!--                                <li>
                            ...
                            <ul class="total_price bg_light_color_1 t_align_r color_dark">
                                ...
                                <li>Total: <b class="f_size_large bold scheme_color sc_price t_align_l d_inline_b m_left_15">TK. {{ Cart::getSubTotal() }}</b></li>
                            </ul>
