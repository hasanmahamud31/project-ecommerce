    ...
    <section class="content invoice">                    
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <img src="{{url::to('admin_resource/img/credit/visa.png')}}" alt="Visa"/>
                <img src="{{url::to('admin_resource/img/credit/mastercard.png')}}" alt="Mastercard"/>
                <img src="{{url::to('admin_resource/img/credit/american-express.png')}}" alt="American Express"/>
                <img src="{{url::to('admin_resource/img/credit/paypal2.png')}}" alt="Paypal"/>
