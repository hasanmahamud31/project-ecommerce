    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Enter the Correct color </h3>
            </div><!-- /.box-header -->
            @if (count($errors) > 0)
            <!-- Form Error List -->
            ...
            <!-- form start -->
            <form method="POST" role="form" action="{{route('store_product_color')}}" >
                {!! csrf_field() !!}
                <div class="box-body">               
                    <div class="form-group">
                        <label for="exampleInputcolor">Enter Size</label>
                        <input type="text" name="color_name" id="exampleInputcolor">
