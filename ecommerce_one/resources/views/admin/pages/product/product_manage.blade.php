                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a href="{{route('delete_product',['id'=>$product->id])}}"> <button class="btn btn-danger btn-sm" data-widget='remove' data-toggle="tooltip" title="Remove Category"><i class="fa fa-times"></i></button></a>
